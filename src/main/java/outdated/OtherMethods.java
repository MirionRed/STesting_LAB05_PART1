...
public class OtherMethods {
	...
	public int countWordInString(String words, String strFind) {
		...
		//if(strFind == null) {throw new IllegalArgumentException();}
	...
	public int findLargestNumberInArray(int[] numArray) {
		//if(numArray == null) throw new IllegalArgumentException();
	...
	public double averageStringLength(String[] strArray, int x) {
		if(strArray == null) throw new IllegalArgumentException();
	...
	public double getStudentAverage(Student[] studArray, String[] namesToFind) {
		if(studArray == null) throw new IllegalArgumentException();
		if(namesToFind == null) throw new IllegalArgumentException();
		int countStudent = 0;
		int sumAge = 0;
	...
	public String getSubStrings(String[] strArray, int[] strPos) {
		if(strArray == null) throw new IllegalArgumentException();
		if(strPos == null) throw new IllegalArgumentException();
		String returnStr = "";
		String[] words;
